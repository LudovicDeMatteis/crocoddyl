...
class ContactModel6DLoopTpl : public ContactModelAbstractTpl<_Scalar> {
 public:
   ...
   * @param[in] frame1_id     Reference frame id of the first contact frame
   * @param[in] frame2_id     Reference frame id of the second contact frame
  ...
  ContactModel6DLoopTpl(boost::shared_ptr<StateMultibody> state,
                    const pinocchio::FrameIndex frame1_id, const pinocchio::FrameIndex frame2_id,
                    const pinocchio::ReferenceFrame ref, const std::size_t nu,
   ...
   * @param[in] joint1_placement     Placement of the first contact with respect to the joint
   * @param[in] joint2_id     Reference joint id of the second contact
   * @param[in] joint2_placement     Placement of the second contact with respect to the joint
   * @param[in] ref    Reference frame of contact
   * @param[in] nu     Dimension of the control vector
   * @param[in] gains  Baumgarte stabilization gains
   */
...
// TODO Add getters and setters for the reference frame placements and the reference joints placements
 ...
 private:
  ...
  SE3 joint1_placement_;  //!< Placement of the first contact with respect to the joint
  int joint2_id_;   //!< Reference joint id of the second contact
  SE3 joint2_placement_;  //!< Placement of the second contact with respect to the joint
  pinocchio::FrameIndex frame1_id_;  //!< Reference frame id of the first contact frame
  pinocchio::FrameIndex frame2_id_;  //!< Reference frame id of the second contact frame
  Vector2s gains_;  //!< Baumgarte stabilization gains
  bool is_frame_;   //!< If true, the contact is defined by frames. Otherwise, it is defined by joints
};
...
struct ContactData6DLoopTpl : public ContactDataAbstractTpl<_Scalar> {
  ...
  SE3 f1Mf2; // Relative placement of the contact frames
