...
void exposeContact6DLoop() {
  ...
  bp::class_<ContactModel6DLoop, bp::bases<ContactModelAbstract> >(
      ...
      bp::init<boost::shared_ptr<StateMultibody>, int, pinocchio::SE3, int,
          ...
          bp::args("self", "state", "joint1_id", "joint1_placement", "joint2_id", "joint2_placement", "ref", "nu", "gains"),
      ...
      .def("calcDiff", &ContactModel6DLoop::calcDiff, bp::args("self", "data", "x"),
  ...
  bp::class_<ContactData6DLoop, bp::bases<ContactDataAbstract> >(
      ...
      .add_property("a1_partial_dq",
                    bp::make_getter(&ContactData6DLoop::a1_partial_dq,
                                    bp::return_internal_reference<>()),
                    "Jacobian of the spatial acceleration of the first contact frame wrt q")
      .add_property("a1_partial_dv",
                    bp::make_getter(&ContactData6DLoop::a1_partial_dv,
                                    bp::return_internal_reference<>()),
                    "Jacobian of the spatial acceleration of the first contact frame wrt v")
      .add_property("a1_partial_da",
                    bp::make_getter(&ContactData6DLoop::a1_partial_da,
                                    bp::return_internal_reference<>()),
                    "Jacobian of the spatial acceleration of the first contact frame wrt a")
     .add_property("v2_partial_dq",
     ...
     .add_property("a2_partial_dq",
               bp::make_getter(&ContactData6DLoop::a2_partial_dq,
                                   bp::return_internal_reference<>()),
               "Jacobian of the spatial acceleration of the second contact frame wrt q")
     .add_property("a2_partial_dv",
               bp::make_getter(&ContactData6DLoop::a2_partial_dv,
                                   bp::return_internal_reference<>()),
               "Jacobian of the spatial acceleration of the second contact frame wrt v")
     .add_property("a2_partial_da",
               bp::make_getter(&ContactData6DLoop::a2_partial_da,
                                   bp::return_internal_reference<>()),
               "Jacobian of the spatial acceleration of the second contact frame wrt a")
     .add_property("da0_dx",
     ...
     .add_property("da0_dq_t3",
      ...
      .add_property("j1Xf1", 
                    bp::make_getter(&ContactData6DLoop::j1Xf1, 
                                    bp::return_internal_reference<>()),
                    "Placement of the first contact frame in the joint frame - Action Matrix")
        .add_property("j2Xf2",
                    bp::make_getter(&ContactData6DLoop::j2Xf2,
                                    bp::return_internal_reference<>()),
                    "Placement of the second contact frame in the joint frame - Action Matrix")
        .add_property("f1Mf2", 
