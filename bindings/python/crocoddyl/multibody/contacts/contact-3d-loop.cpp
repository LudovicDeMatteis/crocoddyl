...
#include "crocoddyl/multibody/contacts/contact-3d-loop.hpp"
...
void exposeContact3DLoop() {
  bp::register_ptr_to_python<boost::shared_ptr<ContactModel3DLoop> >();

  bp::class_<ContactModel3DLoop, bp::bases<ContactModelAbstract> >(
      "ContactModel3DLoop",
      "Rigid 3D contact model.\n\n"
      "It defines a rigid 3D contact models based on acceleration-based "
      ...
      bp::init<boost::shared_ptr<StateMultibody>, int, pinocchio::SE3, int,
          ...
          "np.matrix([0.,0.]))"))
      .def("calc", &ContactModel3DLoop::calc, bp::args("self", "data", "x"),
           "Compute the 3D loop-contact Jacobian and drift.\n\n"
           "The rigid contact model throught acceleration-base holonomic "
           "constraint\n"
           "of the contact frame placement.\n"
           ":param data: contact data\n"
           ":param x: state point (dim. state.nx)")
      .def("calcDiff", &ContactModel3DLoop::calcDiff,
           bp::args("self", "data", "x"),
           "Compute the derivatives of the 3D loop-contact holonomic "
           "constraint.\n\n"
           "The rigid contact model throught acceleration-base holonomic "
           "constraint\n"
           "of the contact frame placement.\n"
      ...
      .def("createData", &ContactModel3DLoop::createData,
           bp::with_custodian_and_ward_postcall<0, 2>(),
           bp::args("self", "data"),
           "Create the 3D loop-contact data.\n\n"
      ...
      .add_property(
          "joint1_id",
          bp::make_function(&ContactModel3DLoop::get_joint1_id,
                            bp::return_value_policy<bp::return_by_value>()),
          "Parent joint id of the first contact frame")
      .add_property(
          "joint1_placement",
          bp::make_function(&ContactModel3DLoop::get_joint1_placement,
                            bp::return_value_policy<bp::return_by_value>()),
          "Placement of the first contact frame with respect to the parent "
          "joint")
      .add_property(
          "joint2_id",
          bp::make_function(&ContactModel3DLoop::get_joint2_id,
                            bp::return_value_policy<bp::return_by_value>()),
          "Parent joint id of the second contact frame")
      .add_property(
          "joint2_placement",
          bp::make_function(&ContactModel3DLoop::get_joint2_placement,
                            bp::return_value_policy<bp::return_by_value>()),
          "Placement of the second contact frame with respect to the parent "
          "joint")
      .add_property(
          "gains",
          bp::make_function(&ContactModel3DLoop::get_gains,
                            bp::return_value_policy<bp::return_by_value>()),
          "Baumegarte stabilisation gains (Kp, Kd)")
      .def(CopyableVisitor<ContactModel3DLoop>());

  bp::register_ptr_to_python<boost::shared_ptr<ContactData3DLoop> >();

  bp::class_<ContactData3DLoop, bp::bases<ContactDataAbstract> >(
      "ContactData3DLoop", "Data for 3DLoop contact.\n\n",
      bp::init<ContactModel3DLoop*, pinocchio::Data*>(
          bp::args("self", "model", "data"),
          "Create 3D loop-contact data.\n\n"
          ":param model: 3D loop-contact model\n"
      ...
      .add_property("j1Xf1",
                    ...
                    "Action Matrix")
      .add_property("j2Xf2",
                    bp::make_getter(&ContactData3DLoop::j2Xf2,
                                    bp::return_internal_reference<>()),
      ...
      .add_property("f1Xf2",
                    bp::make_getter(&ContactData3DLoop::f1Xf2,
                                    bp::return_internal_reference<>()),
      ...
      .add_property("f2vf2",
                    bp::make_getter(&ContactData3DLoop::f2vf2,
                                    bp::return_internal_reference<>()),
                    "Velocity of the second contact frame")
      .add_property(
          "f1vf2",
          bp::make_getter(&ContactData3DLoop::f1vf2,
                          bp::return_internal_reference<>()),
          "Velocity of the second contact frame in the first contact frame")
      .add_property("f1af1",
                    bp::make_getter(&ContactData3DLoop::f1af1,
                                    bp::return_internal_reference<>()),
                    "Acceleration of the first contact frame")
      .add_property("f2af2",
                    bp::make_getter(&ContactData3DLoop::f2af2,
                                    bp::return_internal_reference<>()),
                    "Acceleration of the second contact frame")
      .add_property(
          "f1af2",
          bp::make_getter(&ContactData3DLoop::f1af2,
                          bp::return_internal_reference<>()),
          "Acceleration of the second contact frame in the first contact frame")
      .add_property("joint1_f",
                    bp::make_getter(&ContactData3DLoop::joint1_f,
                                    bp::return_internal_reference<>()),
                    "Force at the first joint")
      .add_property("joint2_f",
                    bp::make_getter(&ContactData3DLoop::joint2_f,
                                    bp::return_internal_reference<>()),
                    "Force at the second joint")
      .add_property("opos", 
                    bp::make_getter(&ContactData3DLoop::opos, 
                                    bp::return_internal_reference<>()), 
                    "Position error between the contact points in world frame")
      .add_property("pos_error",
      ...
      .add_property("vel_error",
                    bp::make_getter(&ContactData3DLoop::vel_error,
                                    bp::return_internal_reference<>()),
                    "Velocity error between the contact points")
      .add_property("oRf1",
                    bp::make_getter(&ContactData3DLoop::oRf1,
                                    bp::return_internal_reference<>()),
                    "Rotation matrix of the first contact frame")
      .add_property("oRf2",
                    bp::make_getter(&ContactData3DLoop::oRf2,
                                    bp::return_internal_reference<>()),
                    "Rotation matrix of the second contact frame")
      .add_property("f1Rf2",
                    bp::make_getter(&ContactData3DLoop::f1Rf2,
                                    bp::return_internal_reference<>()),
                    "Relative rotation matrix between the contact frames")
      .def(CopyableVisitor<ContactData3DLoop>());
}
